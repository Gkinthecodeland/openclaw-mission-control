      ...
      <SectionBody width="narrow" className="space-y-4">
        ...
        {data ? (
          <>
            <div className="rounded-xl border border-border/70 bg-card p-4">
              ...
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-md border border-border/70 bg-muted/30 p-3">
                  ...
                  <p className="mt-1 text-lg font-semibold">{data.summary.agents}</p>
                </div>
                <div className="rounded-md border border-border/70 bg-muted/30 p-3">
                ...
                <div className="rounded-md border border-border/70 bg-muted/30 p-3">
                  ...
                  <p className="mt-1 text-lg font-semibold">{data.summary.configEnvKeys}</p>
                </div>
                <div className="rounded-md border border-border/70 bg-muted/30 p-3">
                  <p className="text-xs text-muted-foreground">Process Env Credentials</p>
                  <p className="mt-1 text-lg font-semibold">{data.summary.processEnvKeys}</p>
                </div>
                <div className="rounded-md border border-border/70 bg-muted/30 p-3">
                ...
                <div className="rounded-md border border-border/70 bg-muted/30 p-3 sm:col-span-2">
                  ...
                  <p className="mt-1 text-lg font-semibold">{data.summary.configSecrets}</p>
                </div>
              </div>
            </div>

            <div className="rounded-xl border border-border/70 bg-card p-4">
              <h2 className="text-sm font-semibold text-foreground">Channel Accounts</h2>
            ...
            <div className="rounded-xl border border-border/70 bg-card p-4">
              <h2 className="text-sm font-semibold text-foreground">Skill Credential Matrix</h2>
              <p className="mt-1 text-xs text-muted-foreground">
            ...
            <div className="rounded-xl border border-border/70 bg-card p-4">
              <h2 className="text-sm font-semibold text-foreground">Discovered Credential Sources</h2>
              <p className="mt-1 text-xs text-muted-foreground">
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-xl border border-border/70 bg-card p-4">
                <h2 className="text-sm font-semibold text-foreground">Config Env Credentials</h2>
                <p className="mt-1 text-xs text-muted-foreground">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {!editor.editing ? (
                              ...
                              <button
                                ...
                                className="rounded border border-emerald-500/40 px-2 py-1 text-[11px] text-emerald-300 hover:bg-emerald-500/10 disabled:opacity-50"
                                disabled={saving}
                              >
                                {saving ? "Saving..." : "Save"}
                              </button>
                        ...
                        <div className="mt-2 space-y-1">
                          <label className="block">
                            ...
                            <input
                              ...
                              className="mt-1 w-full rounded border border-border bg-background px-2 py-1.5 font-mono text-[11px] text-muted-foreground"
                            />
                          </label>
                          {editor.editing && (
                            <>
                              <label className="block">
                                <span className="text-[11px] text-muted-foreground">New value</span>
                                <input
                                  ...
                                  className="mt-1 w-full rounded border border-border bg-background px-2 py-1.5 font-mono text-[11px]"
                                />
                              </label>
                              <label className="block">
                                <span className="text-[11px] text-muted-foreground">Confirm new value</span>
                                <input
                                  type={editor.show ? "text" : "password"}
              ...
              <div className="rounded-xl border border-border/70 bg-card p-4">
                <h2 className="text-sm font-semibold text-foreground">Process Env Credentials</h2>
            ...
            <div className="rounded-xl border border-border/70 bg-card p-4">
              <h2 className="text-sm font-semibold text-foreground">Config Secrets (Non-env)</h2>
              <p className="mt-1 text-xs text-muted-foreground">

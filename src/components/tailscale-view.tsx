        ...
        <div className="rounded-xl border border-border/70 bg-card p-4">
          ...
          <div className="mt-4 rounded-md border border-border bg-background/60 p-3">
            ...
            <div className="mt-3 space-y-2">
              <p className="text-[11px] text-muted-foreground">Advanced command (`tailscale &lt;args...&gt;`)</p>
              <div className="flex items-center gap-2">
                <input
              ...
              <p className="text-[11px] text-muted-foreground">Examples: <code>status --json</code>, <code>ip -4</code>, <code>ping host.tailnet.ts.net</code></p>
              {cliOutput && (
                <pre className="max-h-48 overflow-auto rounded-md border border-border bg-background p-2 text-[11px] text-muted-foreground">
                  {cliOutput}
                </pre>
              )}
            </div>
